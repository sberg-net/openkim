...
import net.sberg.openkim.common.mail.signreport.SignReportService;
...
import net.sberg.openkim.konfiguration.konnektor.card.KonnektorCardService;
import net.sberg.openkim.konfiguration.konnektor.webservice.CertificateService;
import net.sberg.openkim.konfiguration.konnektor.webservice.EncryptionService;
import net.sberg.openkim.konfiguration.konnektor.webservice.SignatureService;
...
public class MailService {
    ...
    public List<String> getAddresses(MimeMessage mimeMessage, boolean checkFrom) throws Exception {

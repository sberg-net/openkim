...
import net.sberg.openkim.konfiguration.fachdienst.FachdienstService;
import net.sberg.openkim.konfiguration.konnektor.card.KonnektorCardService;
import net.sberg.openkim.konfiguration.konnektor.card.KonnektorConnectionInfoService;
import net.sberg.openkim.konfiguration.konnektor.ntp.NtpResult;
import net.sberg.openkim.konfiguration.konnektor.ntp.NtpService;
